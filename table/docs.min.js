...
function AnchorJS(a) {
  ...
  (this.options = a || {}),
      ...
      for (
        ...
        if (this.hasAnchorJSLink(e[i])) q.push(i);
          ...
          (n = h.replace(/-/g, " ")),
            ...
            "" === this.options.icon &&
              ((o.style.fontFamily = "anchorjs-icons"),
    ...
    (this.hasAnchorJSLink = function(a) {
      var b =
          (" " + a.firstChild.className + " ").indexOf(" anchorjs-link ") > -1,
...
!(function(a, b) {
  "object" == typeof exports && "object" == typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(b)
      : "object" == typeof exports ? (exports.Holder = b()) : (a.Holder = b());
})(this, function() {
  return (function(a) {
    function b(d) {
              ...
              (K.vars.preempted = !0),
                ...
                -1 === K.setup.renderers.join(",").indexOf(c.renderer) &&
                  (c.renderer = K.setup.supportsSVG
                    ? "svg"
                    : K.setup.supportsCanvas ? "canvas" : "html");
              var h = D(g.images),
                i = D(g.bgnodes),
                j = D(g.stylenodes),
                k = D(g.objects);
          ...
          N.hasOwnProperty(c) &&
            (b[c] =
              "object" == typeof N[c] && null !== N[c]
                ? "length" in N[c] ? N[c].slice(0) : D({}, N[c])
                : N[c]);
        return b;
      }
